...
#'
#' Simulated data for the first round of an elicitation process estimating three
#' variables with three different elicitation methods.
#'
...
#'
#' Simulated data for the second round of an elicitation process estimating
#' three variables with three different elicitation methods.
#'
#' @format A data frame with 6 rows and 9 columns:
#' \describe{
#'   \item{name}{Name of the expert (randomly generater).}
