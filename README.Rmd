...
* Categorical method (adapted from Vernet et al. (2020, Biological invasion)) <img src="man/figures/elicitr_logo_scaled.png" width="10%" />
...
The functioning and application of {elicitr} is related to following R packages:
